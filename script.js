  ...
  gallery.innerHTML=`
    <div class="container">
      ...
      <div class="gallery-rows">
        <figure class="gallery-row"><img src="images/gallery/gallery-row-1.svg?v=20260719-residential" alt="Four illustrative residential before and after concrete resurfacing examples including driveway, patio, pool deck and sidewalk" loading="lazy"><figcaption>Driveways · Patios · Pool decks · Sidewalks</figcaption></figure>
        <figure class="gallery-row"><img src="images/gallery/gallery-row-2.svg?v=20260719-residential" alt="Four illustrative residential before and after concrete resurfacing examples including front entry, steps, stamped patio and driveway" loading="lazy"><figcaption>Front entries · Steps · Stamped patios · Driveways</figcaption></figure>
        <figure class="gallery-row"><img src="images/gallery/gallery-row-3.svg?v=20260719-residential" alt="Four additional illustrative residential before and after concrete resurfacing examples including walkway, pool deck, patio and front step" loading="lazy"><figcaption>Walkways · Pool decks · Patios · Front steps</figcaption></figure>
      </div>
